 ...
 *
 * @command should point to a valid string. If the command does not contain "ls",
 ...
 *
 * Return: A pointer to the dynamically allocated full path string, or NULL on failure.
 */
 ...
 * line consists entirely of a comment, the corresponding command is set to NULL.
 */
